...
On confond souvent les trois, alors que le goût n'a rien à voir :
...
Aucun équipement n'est indispensable : un bocal et une passoire doublée d'un filtre papier suffisent. Mais deux options rendent l'opération plus propre :

- **La cafetière à piston** : la mouture infuse dedans, on presse, on transvase. Le filtrage est un peu moins net qu'au papier (quelques fines passent), ce qui donne un cold brew plus corsé.
