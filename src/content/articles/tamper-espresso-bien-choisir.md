...
description: "Diamètre, poids, base plate ou convexe : nos critères pour choisir un tamper à espresso adapté à votre machine, et la méthode pour tasser la mouture sans erreur."
pubDate: 2026-09-17
...
comparison:
  columns: ["Type de tamper", "Diamètre à vérifier", "Régularité du geste", "Idéal pour"]
  rows:
...
> Pour comparer les tampers disponibles en ce moment (diamètres, matières, bases) : [voir les tampers à espresso sur Amazon](https://www.amazon.fr/s?k=tamper+espresso&tag=moncafemaison-21).
>
> *En tant que Partenaire Amazon, je réalise un bénéfice sur les achats remplissant les conditions requises.*

## Base plate ou base convexe

**La base plate** est la référence la plus répandue et la plus simple à maîtriser : elle produit un lit de mouture parfaitement horizontal, dont l'uniformité se vérifie d'un coup d'œil après le tassage.

**La base convexe**, légèrement bombée, pousse la mouture vers les bords du panier lors de la pression. L'idée est de limiter le risque de fissuration au centre du puck si la mouture n'a pas été parfaitement nivelée au préalable. L'écart de résultat reste toutefois modeste sur une mouture déjà bien répartie, ce qui explique que la base plate demeure le choix par défaut pour un usage domestique.

## La matière et la prise en main

**L'inox** est la matière la plus courante pour la base du tamper : elle ne s'use pas, se nettoie en un geste et ne retient aucune odeur, contrairement à une base en aluminium anodisé qui peut légèrement se rayer avec le temps.

**Le manche** varie entre le bois, la résine et le métal. Le confort de prise en main compte réellement sur la durée : un manche trop fin ou anguleux devient inconfortable dès qu'on tasse plusieurs cafés à la suite, tandis qu'un manche large et ergonomique répartit mieux la pression appliquée par le poignet.

**Le poids total** de l'ensemble influe surtout sur le confort perçu, pas sur la qualité du tassage : un tamper léger utilisé avec une pression ferme donne un résultat identique à un modèle lourd utilisé avec moins d'effort actif. Un modèle plus lourd demande simplement moins de force musculaire à fournir pour atteindre le même résultat.

## Tamper fixe ou tamper calibré (à ressort)
...
- [Réussir son espresso maison](/articles/reussir-espresso-maison/)
- [Meilleure machine expresso](/articles/meilleure-machine-expresso/)
- [Machine expresso avec broyeur intégré](/articles/machine-expresso-broyeur-integre/)
