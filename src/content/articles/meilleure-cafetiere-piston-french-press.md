...
faq:
  ...
  - question: "Combien de temps laisser infuser ?"
    answer: "Environ 4 minutes est un bon point de départ : on verse l'eau à ~93 °C sur le café, on attend, puis on abaisse le piston lentement. Plus l'infusion est longue, plus le café est corsé — à ajuster selon ton goût."
  - question: "Verre ou inox : que choisir ?"
    answer: "Le verre offre le rendu classique et coûte moins cher, mais il est fragile et perd vite la chaleur. L'inox est incassable et souvent isotherme, donc plus pratique au quotidien et pour emporter, au prix d'un tarif un peu supérieur."
---
...
- **Le matériau** : verre (rendu classique, économique, mais fragile) ou inox (incassable, souvent isotherme)
- **La qualité du filtre** : un tamis fin et bien ajusté limite les résidus dans la tasse
- **La contenance** : de 350 ml (1 tasse) à 1 L (8 tasses) selon le nombre de buveurs
- **L'isolation** : un modèle isotherme garde le café chaud pendant la dégustation
- **La facilité de nettoyage** : filtre démontable et pièces compatibles lave-vaisselle sont un vrai plus

## Comment choisir selon ton usage

Pour **découvrir** la French press sans investir, une cafetière en verre d'une marque fiable fait parfaitement l'affaire : c'est le meilleur rapport plaisir/prix pour se lancer. Veille juste à la manipuler avec soin.

Si tu es **maladroit, pressé ou nomade**, l'inox isotherme est plus rassurant : incassable, il garde la chaleur et supporte mieux le quotidien (bureau, déplacements). Le surcoût se justifie par la durabilité.

Dans les deux cas, le vrai secret d'une bonne French press tient à la mouture : grossière et régulière. C'est l'accessoire — le moulin — qui fait la différence, bien plus que le modèle de cafetière lui-même.
...
Pour la méthode complète, minute par minute, on a détaillé la marche à suivre dans [réussir sa French press](/articles/reussir-french-press-piston/).

## Verre, inox ou plastique : ce que ça change vraiment

Le **verre** utilisé est en général du borosilicate : il encaisse bien les chocs thermiques (eau chaude dans une carafe froide), mais pas les chocs mécaniques — un coup contre l'évier et c'est fini. Avant d'acheter, vérifie que la marque vend la **carafe de rechange** seule : c'est ce qui distingue une cafetière qu'on garde dix ans d'une cafetière jetable.

L'**inox double paroi** est incassable et garde le café chaud, mais il a un revers : tu ne vois pas le niveau ni la couleur de l'infusion, et un modèle isotherme continue de faire infuser le café plus longtemps si tu le laisses dedans. Il est aussi plus lourd.

Le **plastique sans BPA** existe surtout pour le camping et les déplacements : léger, incassable, mais il garde parfois les odeurs et se raye. Un bon choix secondaire, pas un premier achat.
