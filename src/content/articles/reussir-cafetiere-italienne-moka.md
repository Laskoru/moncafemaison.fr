...
Les moka classiques sont en **aluminium** et ne fonctionnent donc **pas sur induction** (sauf modèle inox ou avec un disque adaptateur). Pour l'entretien, on rince à l'eau **claire, sans savon** : le film qui se dépose protège le goût, et le détergent laisse un arrière-goût. On sèche bien toutes les pièces, et on remplace le **joint** quand il durcit (sinon la montée se fait mal). Pour comparer les modèles et les tailles, voir notre guide [bien choisir sa cafetière italienne](/articles/cafetiere-italienne-moka/).

## Les erreurs classiques

- **Feu à fond** : la cause n°1 de l'amertume. Doux suffit.
